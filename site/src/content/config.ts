...
const posts = defineCollection({
  ...
  schema: z.object({
    ...
    // Optional cover: the id of a fragment (must also appear in `fragments`)
    // whose (graded-or-original) first image becomes the post's opener/hero,
    // overriding the default "first fragment that has an image" heuristic in
    // pages/posts/[slug].astro. Absent → the heuristic picks the opener.
